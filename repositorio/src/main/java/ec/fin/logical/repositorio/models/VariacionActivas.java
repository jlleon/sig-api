...
@Document(collection = "variacion_activas")
public class VariacionActivas {
    @Id
    public ObjectId _id;
     ...
     * @param tipo
     */
    public VariacionActivas(ObjectId _id, String fecha, String tipo_institucion, String nombre_corto,
            String nombre_largo, String producto, String segmento, String segmento_cartera, BigDecimal valor_inicial, 
            BigDecimal valor_final, String tipo) {
        this._id = _id;
        this.fecha = fecha;
