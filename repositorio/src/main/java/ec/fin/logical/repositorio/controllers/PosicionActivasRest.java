...
public class PosicionActivasRest {

    @Autowired
    private PosicionActivasService service;

    @CrossOrigin("*")
    @RequestMapping(value = "/posicion", method = RequestMethod.GET)
    @ResponseBody
    public List<PosicionActivas> obtenerTodos() {
        try {
    ...
    @ResponseBody
    public List<PosicionActivas> buscarPosicionPorFecha(@PathVariable(value = "fecha") String fecha) {
        try {
    ...
    @ResponseBody
    public List<PosicionActivas> buscarPosicionPorFecha(@PathVariable(value = "fecha") String fecha, @PathVariable(value = "tipoInstitucion") String tipoInstitucion) {
        try {
    ...
    @ResponseBody
    public List<VariacionActivas> buscarVariacionPorFecha(@PathVariable(value = "fecha") String fecha) {
        try {
    ...
    @ResponseBody
    public List<VariacionActivas> buscarVariacionPorFecha(@PathVariable(value = "fecha") String fecha, @PathVariable(value = "tipoInstitucion") String tipoInstitucion) {
        try {
